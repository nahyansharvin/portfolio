...
const AboutMe = () => {
  return (
    <section id='about' className='p-section-padding py-52 flex gap-5'>
        ...
        <div className='max-w-xl flex flex-col gap-8 items-start'>
            ...
            <p className='font-light leading-loose'>I am a self-taught developer with a relentless passion for harnessing technology and design to pioneer innovative real-world solutions. With over two years of hands-on experience in building software for web and mobile applications, I am driven by a desire to push the boundaries of what is possible and to breathe life into new projects from their conceptual stages.</p>
